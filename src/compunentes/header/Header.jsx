                    ...
                    <nav className="header_navbar">
                        <ul className="header_navbar-list">
                            ...
                            <li className="header_navbar-item header_navbar-item--pillar2 ">
                                <a className="header_navbar-item-link  ">Trở thành Người bán Bootscamp-1</a>
                            </li>
                            ...
                            {userInfo.role ? (
                                <li className="header_navbar_item_mypage">
                                    ...
                                    <div className="header_navbar_iteam_mypage_selec">
                                        <div onClick={on_mypage}>Tài khoản của tôi</div>
                        ...
                        <div className="header_cart">
                            <div className="header_cart-wrap">
                                ...
                                <div className="header_cart-list header_cart-list--no-cart">
                                    ...
                                    />
                                    <p className="header_cart-list--no-cart-messenger">Chưa Có Sản Phẩm</p>
                                </div>
                            </div>
                        </div>
                    </div>
