...
function FilterProduct(props) {
    ...
    useEffect(() => {
        ...
        let arrSearchFiterItem = [searchBrand, searchPrice, searchTypePhone, searchPerfomance, searchRam, searchRom, searchCamera, searchFearture, searchDesign, searchPanel]
        for (let i = 0; i < arrSearchFiterItem.length; i++) {
            if (arrSearchFiterItem[i]) {
                let listBrand = arrSearchFiterItem[i].split(',')
                listBrand.map(brand => {
                    document.querySelector(`.category-item-detail[index="${brand}"]`).classList.add('myStyle')
                })
            }
        }
    }, [])
                    ...
                    <div className="row sm-gutter app__content">
                                        ...
                                        <div className="category-item_link">
                                            ...
                                            <div className="category-item-detail-wrap">
                                                {props.filter.brand.map((val, i) => {
                                                    return <button key={val} onClick={(e) => { filterPages(removeAccents(val), 'brand', e) }} className="category-item-detail" index={val}>{val}</button>
                                                })}
                                            </div>
                                        </div>
                                    </li>
                                        ...
                                        <div className="category-item_link">
                                            ...
                                            <div className="category-item-detail-wrap">
                                                {props.filter.price.map((val, i) => {
                                                    return <button key={val} onClick={(e) => { filterPages(removeAccents(val), 'priceReferent', e) }} className="category-item-detail" index={val}  >{val}</button>
                                                })}
                                            </div>
                                        ...
                                        <div className="category-item_link">
                                            ...
                                            <div className="category-item-detail-wrap">
                                                {props.filter.productType.map((val, i) => {
                                                    return <button key={val} onClick={(e) => { filterPages(removeAccents(val), 'productType', e) }} className="category-item-detail" index={val} >{val}</button>
                                                })}
                                            </div>
                                        </div>
                                    </li>
                                        ...
                                        <div className="category-item_link">
                                            ...
                                            <div className="category-item-detail-wrap">
                                                {props.filter.performanceProduct.map((val, i) => {
                                                    return <button key={val} onClick={(e) => { filterPages(removeAccents(val), 'performanceProduct', e) }} className="category-item-detail" index={val} >{val}</button>
                                                })}
                                            </div>
                                        </div>
                                    </li>
                                        ...
                                        <div className="category-item_link">
                                            ...
                                            <div className="category-item-detail-wrap">
                                                {props.filter.ram.map((val, i) => {
                                                    return <button onClick={(e) => { filterPages(removeAccents(val), 'ram', e) }} className="category-item-detail" index={val} >{val}</button>
                                                })}
                                            </div>
                                        </div>
                                    </li>
                                        ...
                                        <div className="category-item_link">
                                            ...
                                            <div className="category-item-detail-wrap">
                                                {props.filter.rom.map((val, i) => {
                                                    return <button key={val} onClick={(e) => { filterPages(removeAccents(val), 'rom', e) }} className="category-item-detail" index={val} >{val}</button>
                                                })}
                                            </div>
                                        </div>
                                    </li>
                                        ...
                                        <div className="category-item_link">
                                            ...
                                            <div className="category-item-detail-wrap">
                                                {props.filter.cameraProduct.map((val, i) => {
                                                    return <button key={val} onClick={(e) => { filterPages(removeAccents(val), 'cameraProduct', e) }} className="category-item-detail" index={val} >{val}</button>
                                                })}
                                            </div>
                                        </div>
                                    </li>
                                        ...
                                        <div className="category-item_link">
                                            ...
                                            <div className="category-item-detail-wrap">
                                                {props.filter.specialFeatures.map((val, i) => {
                                                    return <button key={val} onClick={(e) => { filterPages(removeAccents(val), 'specialFeatures', e) }} className="category-item-detail" index={val} >{val}</button>
                                                })}
                                            </div>
                                        </div>
                                    </li>
                                        ...
                                        <div className="category-item_link">
                                            ...
                                            <div className="category-item-detail-wrap">
                                                {props.filter.design.map((val, i) => {
                                                    return <button key={val} onClick={(e) => { filterPages(removeAccents(val), 'design', e) }} className="category-item-detail" index={val} >{val}</button>
                                                })}
                                            </div>
                                        </div>
                                    </li>
                                        ...
                                        <div className="category-item_link">
                                            ...
                                            <div className="category-item-detail-wrap">
                                                {props.filter.panel.map((val, i) => {
                                                    return <button key={val} onClick={(e) => { filterPages(removeAccents(val), 'panel', e) }} className="category-item-detail" index={val} >{val}</button>
                                                })}
                                            </div>
                                        </div>
                                    </li>
                        ...
                        <div className="col1 l-10 m-12 c-12">
                            <div className="home-filter hide-on-moble-tablet">
                                ...
                                <button className="home-filter_btn btn commonButton" onClick={(e) => { sortCommon(e) }}>Phổ biến</button>
                                <button className="home-filter_btn btn newestButton" onClick={(e) => { sortNewst(e) }}>Mới nhất</button>
                                <button className="home-filter_btn btn salestButton" onClick={(e) => { sortBestSale(e) }}>Bán chạy</button>

                                <div className="select-input">
                                    <button className="select-input__label">Giá</button>
                                    <i className="home-filter-select-icon fas fa-chevron-down">
                                    </i>
                                    {/* <!-- List option sort  --> */}
                                    <ul className="select-input__list">
                                        <li className="select-input__item">
                                            <button className="select-input__link IncressePrice" onClick={(e) => { sortIncressePrice(e) }}>Giá : Thấp đến cao</button>
                                        </li>
                                        <li className="select-input__item">
                                            <button className="select-input__link DicreasePrice" onClick={(e) => { sortDicreasePrice(e) }}>Giá : Cao đến thấp</button>
                                        </li>
                                    </ul>
                                </div>
                                    ...
                                    {stateSort.map((val, i) => {
                                        ...
                                        return (<div className="col1 l-2-4 m-4 c-12">
                                            <button onClick={() => { movePage(removeAccents(val.productName).split(' ').join('')) }} className="home-product-item">
                                                ...
                                                <h4 className="home-product-item__name">{val.productName}</h4>
                                                <div className="home-product-item__price">
                                                    <div className="home-product-item__price-wrap">
                                                        <span className="home-product-item__price-old">{val.price.toLocaleString()} đ</span>
                                                        <span className="home-product-item__price-curr">{(val.price * (100 - (Number.parseFloat(val.Sale))) / 100).toLocaleString()}<sup> đ</sup></span>
                                                    </div>
                                                    <div className="home-product-item__sale-off">
                                                        <span className="home-product-item__sale-off-percent">-{val.Sale}</span>
                                                ...
                                                <div className="home-product-item__action">
                                                    ...
                                                    <div className="home-product-item_sold">Đã bán {val.countSold}</div>
                                                </div>
