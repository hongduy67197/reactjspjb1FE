                                        ...
                                        <div class="category-item_link">
                                            ...
                                            <div className="category-item-detail-wrap">
                                                {props.filter.price.map((val, i) => {
                                                    return <button key={val} onClick={(e) => { filterPages(removeAccents(val), 'price', e) }} className="category-item-detail">{val}</button>
                                                })}
                                        ...
                                        <div class="category-item_link">
                                            ...
                                            <div className="category-item-detail-wrap">
                                                {props.filter.ram.map((val, i) => {
                                                    return <button key={val} onClick={(e) => { filterPages(removeAccents(val), 'ram', e) }} className="category-item-detail">{val}</button>
                                                })}
