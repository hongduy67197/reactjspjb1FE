        ...
        <div class="row">
            ...
            <div class="col l-2-4 m-4 c-6">
                ...
                <ul class="footer-list">
                    ...
                    <li class="footer-item">
                        <a class="footer-item__link">Chương Trình Tiếp Thị Liên Kết Shopee</a>
                    </li>
                <li class="footer-item">
            ...
            <div class="col l-2-4 m-8 c-12">
                ...
                <div class="footer__download">
                    <img src={require("../asset/img/qr_code.png")} alt="" class="footer__download-qr"/>
                    <div class="footer__download-apps">
                        <img src={require("../asset/img/ios.png")} alt="" class="footer__download-app-icon-img"/>
                        <img src={require("../asset/img/gg_play.png")} alt="" class="footer__download-app-icon-img"/>
                    </div>
                </div>
            </div>
        </div>
