...
function Header(props) {
    ...
    function lightpink() {
        ...
        document.querySelector('.mid input').style.background = 'rgb(255, 227, 231)';
    ...
    function lightblue() {
        ...
        document.querySelector('.mid input').style.background = 'rgb(209, 230, 255)';
        var x = document.querySelectorAll('.menu1');
        for (var i = 0; i < x.length; i++) {
            x[i].style.color = 'black';
        }
    ...
    function lightgrey() {
        ...
        document.querySelector('.mid input').style.background = 'rgb(226, 226, 226)';
        var x = document.querySelectorAll('.menu1');
        for (var i = 0; i < x.length; i++) {
            x[i].style.color = 'black';
        }
    ...
    function black() {
        ...
        document.querySelector('.mid input').style.background = 'rgb(103, 103, 103)';
        var x = document.querySelectorAll('.menu1');
        for (var i = 0; i < x.length; i++) {
    ...
    function purple() {
        ...
        document.querySelector('.mid input').style.background = 'rgb(218, 127, 218)';
        var x = document.querySelectorAll('.menu1');
        for (var i = 0; i < x.length; i++) {
            x[i].style.color = 'white';
        }
    ...
    function green() {
        ...
        document.querySelector('.mid input').style.background = 'rgb(117, 203, 117)';
        var x = document.querySelectorAll('.menu1');
        for (var i = 0; i < x.length; i++) {
            x[i].style.color = 'white';
        }
